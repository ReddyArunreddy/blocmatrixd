...
#include <blocmatrix/json/Writer.h>
#include <test/json/TestOutputSuite.h>
#include <blocmatrix/beast/unit_test.h>

namespace Json {

class JsonWriter_test : public blocmatrix::test::TestOutputSuite
{
public:
    void testTrivial ()
    {
...
BEAST_DEFINE_TESTSUITE(JsonWriter, blocmatrix_basics, blocmatrix);
