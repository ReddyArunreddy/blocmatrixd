...
#ifndef BLOCMATRIX_TEST_JTX_FLAGS_H_INCLUDED
#define BLOCMATRIX_TEST_JTX_FLAGS_H_INCLUDED
...
private:
    ...
    set_args (std::uint32_t flag)
    {
        ...
        case asfDisallowBMC:    mask_ |= lsfDisallowBMC;    break;
        ...
        case asfDefaultBlocmatrix:  mask_ |= lsfDefaultBlocmatrix;  break;
