...
*/
//==============================================================================
#ifndef BLOCMATRIX_TEST_TRUSTED_PUBLISHER_SERVER_H_INCLUDED
#define BLOCMATRIX_TEST_TRUSTED_PUBLISHER_SERVER_H_INCLUDED
...
public:
            ...
            : sock_(ioc), acceptor_(ioc)
    {
        endpoint_type const& ep {
            beast::IP::Address::from_string (blocmatrix::test::getEnvLocalhostAddr()),
