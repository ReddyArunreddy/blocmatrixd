...
#ifndef BLOCMATRIX_TEST_JTX_ENVCONFIG_H_INCLUDED
#define BLOCMATRIX_TEST_JTX_ENVCONFIG_H_INCLUDED
...
/// blocmatrix::Config. The function takes ownership of the unique_ptr and
