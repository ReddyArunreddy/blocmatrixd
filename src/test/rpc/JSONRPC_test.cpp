...
{ "Cannot create BMC to BMC paths.", __LINE__,
R"({
    "command": "doesnt_matter",
    "account": "bHr9CJAWyB4bj91VRWn96DkukG4rwdtyTh",
    "secret": "masterpassphrase",
...
{ "'Amount' may not be BMC for pathfinding, but 'SendMax' may be BMC.", __LINE__,
R"({
    "command": "doesnt_matter",
    "account": "bHr9CJAWyB4bj91VRWn96DkukG4rwdtyTh",
    "secret": "masterpassphrase",
...
public:
    ...
    void testTransactionRPC ()
    {
        ...
        test::jtx::Env env(*this);
        env.fund(test::jtx::BMC(100000), a, ed, g);
        env.close();
...
BEAST_DEFINE_TESTSUITE(JSONRPC,blocmatrix_app,blocmatrix);
