...
#include <blocmatrix/net/RPCCall.h>
...
},
{
    "account_channels: two accounts.", __LINE__,
    {
        "account_channels",
        "bHr9CJAWyB4bj91VRWn96DkukG4rwdtyTh",
        "bnUy2SHTbB9DursPmkJZUXTf5FcNDGbYEA"
    },
    RPCCallTestData::no_exception,
    R"({
    "method" : "account_channels",
    "params" : [
      {
         "account" : "bHr9CJAWyB4bj91VRWn96DkukG4rwdtyTh",
         "destination_account" : "bnUy2SHTbB9DursPmkJZUXTf5FcNDGbYEA"
      }
    ]
    })"
},
...
},
{
    ...
    "params" : [
      {
         "account" : "bHr9CJAWyB4bj91VRWn96DkukG4rwdtyTh",
         "peer" : "bnUy2SHTbB9DursPmkJZUXTf5FcNDGbYEA"
      }
    ]
    })"
},
...
},
{
    ...
    {
        "book_offers",
        "USD/bHr9CJAWyB4bj91VRWn96DkukG4rwdtyTh",
        "EUR/bnUy2SHTbB9DursPmkJZUXTf5FcNDGbYEA",
    },
    RPCCallTestData::no_exception,
    R"({
    "method" : "book_offers",
    "params" : [
      {
         ...
         "taker_pays" : {
            "currency" : "USD",
            "issuer" : "bHr9CJAWyB4bj91VRWn96DkukG4rwdtyTh"
         }
      }
    ]
    })"
    ...
    "params" : [
      {
         "error" : "invalidParams",
         "error_code" : 31,
         "error_message" : "Invalid currency/issuer '/bHr9CJAWyB4bj91VRWn96DkukG4rwdtyTh'"
      }
    ]
    })"
},
    ...
    "params" : [
      {
         "error" : "invalidParams",
         "error_code" : 31,
         "error_message" : "Invalid currency/issuer '/bnUy2SHTbB9DursPmkJZUXTf5FcNDGbYEA'"
      }
    ]
    })"
},
...
// channel_verify --------------------------------------------------------------
{
    ...
    {
        "channel_verify",
        "aB4BXXLuPu8DpVuyq1DBiu3SbPdtK9AYZisKhu8mvkoiUD8J9Gov",
        "0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF",
        "0",
        "DEADBEEF"
    },
    ...
    "params" : [
      {
         "amount" : "0",
         "channel_id" : "0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF",
         "public_key" : "aB4BXXLuPu8DpVuyq1DBiu3SbPdtK9AYZisKhu8mvkoiUD8J9Gov",
         "signature" : "DEADBEEF"
      }
    ]
    })"
...
// json2 -----------------------------------------------------------------------
{
    ...
    {
        "json2",
        R"({"jsonrpc":"2.0","blocmatribmcc":"2.0","id":"A1","method":"call_1"})",
    },
    RPCCallTestData::no_exception,
    R"({
    "id" : "A1",
...
},
{
    ...
    {
        "json2",
        R"({"jsonrpc":"2.0","blocmatribmcc":"2.0","id":"A1","method":"call_this"})",
        "extra"
    },
    RPCCallTestData::no_exception,
    R"({
...
},
{
    ...
    {
        "json2",
        R"({"blocmatribmcc":"2.0","id":"A1","method":"call_1"})",
    },
    RPCCallTestData::no_exception,
    R"({
    "id" : "A1",
...
},
{
    ...
    {
        "json2",
        R"({"jsonrpc":"2.1","blocmatribmcc":"2.0","id":"A1","method":"call_1"})",
    },
    RPCCallTestData::no_exception,
    R"({
    "id" : "A1",
...
{
    "json2: omit blocmatribmcc.", __LINE__,
    {
        "json2",
...
{
    "json2: wrong blocmatribmcc version.", __LINE__,
    {
        "json2",
        R"({"jsonrpc":"2.0","blocmatribmcc":"2.00","id":"A1","method":"call_1"})",
    },
    RPCCallTestData::no_exception,
    R"({
    "id" : "A1",
...
},
{
    ...
    {
        "json2",
        R"({"jsonrpc":"2.0","blocmatribmcc":"2.0","method":"call_1"})",
    },
    RPCCallTestData::no_exception,
    R"({
    "jsonrpc" : "2.0",
...
},
{
    ...
    {
        "json2",
        R"({"jsonrpc":"2.0","blocmatribmcc":"2.0","id":"A1"})",
    },
    RPCCallTestData::no_exception,
    R"({
    "id" : "A1",
...
// blocmatrix_path_find ------------------------------------------------------------
{
    "blocmatrix_path_find: minimal.", __LINE__,
    {
        "blocmatrix_path_find",
        R"({"json_argument":true})",
    },
...
{
    "blocmatrix_path_find: ledger index.", __LINE__,
    {
        "blocmatrix_path_find",
        R"({"json_argument":true})",
        "4294967295"
...
{
    "blocmatrix_path_find: text ledger index.", __LINE__,
    {
        "blocmatrix_path_find",
        R"({"json_argument":true})",
        "closed"
...
{
    "blocmatrix_path_find: ledger hash.", __LINE__,
    {
        "blocmatrix_path_find",
        R"({"json_argument":true})",
        "0123456789ABCDEFGHIJKLMNOPQRSTUV0123456789ABCDEFGHIJKLMNOPQRSTUV"
...
{
    "blocmatrix_path_find: too few arguments.", __LINE__,
    {
        "blocmatrix_path_find",
    },
    RPCCallTestData::no_exception,
...
{
    "blocmatrix_path_find: too many arguments.", __LINE__,
    {
        "blocmatrix_path_find",
        R"({"json_argument":true})",
        "current",
...
{
    "blocmatrix_path_find: invalid json (note extra comma).", __LINE__,
    {
        "blocmatrix_path_find",
        R"({"json_argument":true,})",
    },
...
{
    "blocmatrix_path_find: ledger index too small.", __LINE__,
    {
        "blocmatrix_path_find",
        R"({"json_argument":true})",
        "-1"
...
{
    "blocmatrix_path_find: ledger index too big.", __LINE__,
    {
        "blocmatrix_path_find",
        R"({"json_argument":true})",
        "4294967296"
...
{
    "blocmatrix_path_find: invalid text ledger index.", __LINE__,
    {
        "blocmatrix_path_find",
        R"({"json_argument":true})",
        "cur"
...
BEAST_DEFINE_TESTSUITE(RPCCall,app,blocmatrix);
