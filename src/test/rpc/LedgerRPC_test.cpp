...
#include <blocmatrix/app/misc/Manifest.h>
...
class LedgerRPC_test : public beast::unit_test::suite
{
    ...
    // '!' is not part of the blocmatrix alphabet.
    std::string
    ...
    void testLedgerEntryCheck()
    {
        ...
        env (checkCreate (env.master, alice, BMC(100)));
        env.close();
    ...
    void testLedgerEntryEscrow()
    {
        ...
        env (escrowCreate (alice, alice, BMC(333), env.now() + 2s));
        env.close();
        ...
        std::string escrowIndex;
        {
            ...
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
            BEAST_EXPECT(
                jrr[jss::node][jss::Amount] == BMC(333).value().getText());
    ...
    void testLedgerEntryOffer()
    {
        ...
        env (offer (alice, USD (321), BMC (322)));
        env.close();
    ...
    void testLedgerEntryPayChan()
    {
        ...
        env (payChanCreate (alice, env.master, BMC(57), 18s, alice.pk()));
        env.close();
    ...
    void testLedgerEntryBlocmatrixState()
    {
        testcase ("ledger_entry Request BlocmatrixState");
        using namespace test::jtx;
        Env env {*this};
        Account const alice {"alice"};
        Account const gw { "gateway" };
        ...
        std::string const ledgerHash {to_string (env.closed()->info().hash)};
        {
            ...
            Json::Value jvParams;
            jvParams[jss::blocmatrix_state] = Json::objectValue;
            jvParams[jss::blocmatrix_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::blocmatrix_state][jss::accounts][0u] = alice.human();
            jvParams[jss::blocmatrix_state][jss::accounts][1u] = gw.human();
            jvParams[jss::blocmatrix_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
            BEAST_EXPECT(
        ...
        {
            // blocmatrix_state is not an object.
            Json::Value jvParams;
            jvParams[jss::blocmatrix_state] = "blocmatrix_state";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
            checkErrorValue (jrr, "malformedRequest", "");
        ...
        {
            // blocmatrix_state.currency is missing.
            Json::Value jvParams;
            jvParams[jss::blocmatrix_state] = Json::objectValue;
            jvParams[jss::blocmatrix_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::blocmatrix_state][jss::accounts][0u] = alice.human();
        ...
        {
            // blocmatrix_state accounts is not an array.
            Json::Value jvParams;
            jvParams[jss::blocmatrix_state] = Json::objectValue;
            jvParams[jss::blocmatrix_state][jss::accounts] = 2;
            jvParams[jss::blocmatrix_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // blocmatrix_state one of the accounts is missing.
            Json::Value jvParams;
            jvParams[jss::blocmatrix_state] = Json::objectValue;
            jvParams[jss::blocmatrix_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::blocmatrix_state][jss::accounts][0u] = alice.human();
        ...
        {
            // blocmatrix_state more than 2 accounts.
            Json::Value jvParams;
            jvParams[jss::blocmatrix_state] = Json::objectValue;
            jvParams[jss::blocmatrix_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::blocmatrix_state][jss::accounts][0u] = alice.human();
            jvParams[jss::blocmatrix_state][jss::accounts][1u] = gw.human();
            jvParams[jss::blocmatrix_state][jss::accounts][2u] = alice.human();
            jvParams[jss::blocmatrix_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // blocmatrix_state account[0] is not a string.
            Json::Value jvParams;
            jvParams[jss::blocmatrix_state] = Json::objectValue;
            jvParams[jss::blocmatrix_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::blocmatrix_state][jss::accounts][0u] = 44;
            jvParams[jss::blocmatrix_state][jss::accounts][1u] = gw.human();
            jvParams[jss::blocmatrix_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
        ...
        {
            // blocmatrix_state account[1] is not a string.
            Json::Value jvParams;
            jvParams[jss::blocmatrix_state] = Json::objectValue;
            jvParams[jss::blocmatrix_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::blocmatrix_state][jss::accounts][0u] = alice.human();
            jvParams[jss::blocmatrix_state][jss::accounts][1u] = 21;
            jvParams[jss::blocmatrix_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // blocmatrix_state account[0] == account[1].
            Json::Value jvParams;
            jvParams[jss::blocmatrix_state] = Json::objectValue;
            jvParams[jss::blocmatrix_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::blocmatrix_state][jss::accounts][0u] = alice.human();
            jvParams[jss::blocmatrix_state][jss::accounts][1u] = alice.human();
            jvParams[jss::blocmatrix_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // blocmatrix_state malformed account[0].
            Json::Value jvParams;
            jvParams[jss::blocmatrix_state] = Json::objectValue;
            jvParams[jss::blocmatrix_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::blocmatrix_state][jss::accounts][0u] =
        ...
        {
            // blocmatrix_state malformed account[1].
            Json::Value jvParams;
            jvParams[jss::blocmatrix_state] = Json::objectValue;
            jvParams[jss::blocmatrix_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::blocmatrix_state][jss::accounts][0u] = alice.human();
            jvParams[jss::blocmatrix_state][jss::accounts][1u] =
        ...
        {
            // blocmatrix_state malformed currency.
            Json::Value jvParams;
            jvParams[jss::blocmatrix_state] = Json::objectValue;
            jvParams[jss::blocmatrix_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::blocmatrix_state][jss::accounts][0u] = alice.human();
            jvParams[jss::blocmatrix_state][jss::accounts][1u] = gw.human();
            jvParams[jss::blocmatrix_state][jss::currency] = "USDollars";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
    ...
    void testLookupLedger()
    {
        ...
        env.fund(BMC(10000), "alice");
        env.close();
        env.fund(BMC(10000), "bob");
        env.close();
        env.fund(BMC(10000), "jim");
        env.close();
        env.fund(BMC(10000), "jill");
    ...
    void testQueue()
    {
        ...
        env.fund(BMC(10000), bob);
        env.close();
        env.fund(BMC(10000), charlie);
        env.fund(BMC(10000), daria);
        env.close();
        ...
        env(pay(alice, "george", BMC(1000)), json(R"({"LastLedgerSequence":7})"),
            ter(terQUEUED));
        env(offer(alice, BMC(50000), alice["USD"](5000)), seq(aliceSeq + 1),
            ter(terQUEUED));
...
public:
    void run () override
    {
        ...
        testLedgerEntryBlocmatrixState();
...
BEAST_DEFINE_TESTSUITE(LedgerRPC,app,blocmatrix);
