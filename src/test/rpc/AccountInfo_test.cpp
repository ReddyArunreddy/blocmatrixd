   ...
   void testSignerListsV2()
    {
        ...
        // Alice has no SignerList yet.
        {
            ...
            BEAST_EXPECT(info.isMember(jss::blocmatribmcc) && info[jss::blocmatribmcc] == "2.0");
        ...
        }
        {
            ...
            BEAST_EXPECT(info[0u].isMember(jss::blocmatribmcc) && info[0u][jss::blocmatribmcc] == "2.0");
            ...
            BEAST_EXPECT(info[1u].isMember(jss::blocmatribmcc) && info[1u][jss::blocmatribmcc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(AccountInfo,app,blocmatrix);
