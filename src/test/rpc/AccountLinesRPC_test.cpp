...
public:
    void testAccountLines()
    {
        ...
        for (char c = 0; c <= ('Z' - 'A'); ++c)
        {
            ...
            env(trust(alice, gw2Currency(0), gw2, tfSetNoBlocmatrix | tfSetFreeze));
        }
        env.close();
        ...
        }
        {
            ...
            BEAST_EXPECT(line[jss::no_blocmatrix].asBool() == true);
        ...
        }
        {
            ...
            BEAST_EXPECT(lineA[jss::no_blocmatrix_peer].asBool() == true);
    ...
    void testAccountLineDelete()
    {
        ...
        //   o alice offers to buy 100 USD for 100 BMC.
        //   o becky offers to sell 100 USD for 100 BMC.
        ...
        Account const gw1 {"gw1"};
        Account const gw2 {"gw2"};
        env.fund(BMC(10000), alice, becky, cheri, gw1, gw2);
        env.close();
        ...
        // alice offers to buy 100 EUR for 100 BMC.
        env(offer(alice, EUR(100), BMC(100)));
        env.close();

        // becky offers to buy 100 BMC for 100 EUR.
        env(offer(becky, BMC(100), EUR(100)));
        env.close();
    ...
    void testAccountLines2()
    {
        ...
        Env env(*this);
        {
            ...
            BEAST_EXPECT(lines.isMember(jss::blocmatribmcc) && lines[jss::blocmatribmcc] == "2.0");
        }
        {
            // account_lines with no account.
            auto const lines = env.rpc ("json2", "{ "
        ...
        [this, &env](Account const& account, LedgerInfo const& info, int count)
        {
            ...
            BEAST_EXPECT(linesSeq.isMember(jss::blocmatribmcc) && linesSeq[jss::blocmatribmcc] == "2.0");
            ...
            BEAST_EXPECT(linesHash.isMember(jss::blocmatribmcc) && linesHash[jss::blocmatribmcc] == "2.0");
        ...
        }
        {
            ...
            BEAST_EXPECT(linesA.isMember(jss::blocmatribmcc) && linesA[jss::blocmatribmcc] == "2.0");
            ...
            BEAST_EXPECT(linesB.isMember(jss::blocmatribmcc) && linesB[jss::blocmatribmcc] == "2.0");
            ...
            BEAST_EXPECT(linesC.isMember(jss::blocmatribmcc) && linesC[jss::blocmatribmcc] == "2.0");
            ...
            BEAST_EXPECT(linesD.isMember(jss::blocmatribmcc) && linesD[jss::blocmatribmcc] == "2.0");
    ...
    void testAccountLineDelete2()
    {
        ...
        //   o alice offers to buy 100 EUR for 100 BMC.
        //   o becky offers to sell 100 EUR for 100 BMC.
        ...
        BEAST_EXPECT(linesBeg.isMember(jss::blocmatribmcc) && linesBeg[jss::blocmatribmcc] == "2.0");
        ...
        BEAST_EXPECT(linesEnd.isMember(jss::blocmatribmcc) && linesEnd[jss::blocmatribmcc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(AccountLinesRPC,app,blocmatrix);
