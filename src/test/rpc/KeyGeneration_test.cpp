...
class WalletPropose_test : public blocmatrix::TestSuite
{
public:
    ...
    void testBlocmatrixLibEd25519()
    {
        testcase ("blocmatrix-lib encoded Ed25519 keys");
    ...
    void run() override
    {
        ...
        testBlocmatrixLibEd25519();

        testKeypairForSignatureErrors ();
    }
};

BEAST_DEFINE_TESTSUITE(WalletPropose,blocmatrix_basics,blocmatrix);
