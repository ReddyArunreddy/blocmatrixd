...
public:
    ...
    void testNullAccountSet()
    {
        ...
        env.fund(BMC(10000), noblocmatrix(alice));
    ...
    void testMostFlags()
    {
        ...
        testFlags ({asfRequireDest, asfRequireAuth, asfDisallowBMC,
            asfGlobalFreeze, asfDisableMaster, asfDefaultBlocmatrix});
    ...
    void testBadInputs(bool withFeatures)
    {
        ...
        auto jt = fset(alice, asfDisallowBMC);
        jt[jss::ClearFlag] = asfDisallowBMC;
        ...
        jt = fset(alice, asfDisallowBMC);
        jt[sfFlags.fieldName] = tfAllowBMC;
        env(jt, ter(temINVALID_FLAG));
...
BEAST_DEFINE_TESTSUITE(AccountSet,app,blocmatrix);
