...
public:
    ...
    testGWB(FeatureBitset features)
    {
        ...
        if (wsc->version() == 2)
        {
            ...
            expect(jv.isMember(jss::blocmatribmcc) && jv[jss::blocmatribmcc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(GatewayBalances,app,blocmatrix);
