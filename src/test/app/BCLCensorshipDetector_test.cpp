...
class BCLCensorshipDetector_test : public beast::unit_test::suite
{
    void test(
        BCLCensorshipDetector<int, int>& cdet, int round,
        ...
        std::vector<int> remain, std::vector<int> remove)
    {
        ...
        BCLCensorshipDetector<int, int>::TxIDSeqVec proposal;
...
public:
    ...
    run() override
    {
        ...
        BCLCensorshipDetector<int, int> cdet;
        int round = 0;
...
BEAST_DEFINE_TESTSUITE(BCLCensorshipDetector, app, blocmatrix);
}  // namespace test
}  // namespace blocmatrix
