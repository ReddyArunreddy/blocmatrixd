...
#include <blocmatrix/protocol/InnerObjectFormats.h>
#include <blocmatrix/protocol/ErrorCodes.h>          // RPC::containsError
#include <blocmatrix/json/json_reader.h>             // Json::Reader
#include <blocmatrix/protocol/STParsedJSON.h>        // STParsedJSONObject
...
BEAST_DEFINE_TESTSUITE(InnerObjectFormatsParsedJSON,blocmatrix_app,blocmatrix);
