...
#ifndef BLOCMATRIX_ASSETS_ENABLE_STD_HASH
# if BEAST_MAC || BEAST_IOS
#  define BLOCMATRIX_ASSETS_ENABLE_STD_HASH 0
# else
#  define BLOCMATRIX_ASSETS_ENABLE_STD_HASH 1
# endif
#endif
...
#if BLOCMATRIX_ASSETS_ENABLE_STD_HASH
...
BEAST_DEFINE_TESTSUITE(Issue,protocol,blocmatrix);
