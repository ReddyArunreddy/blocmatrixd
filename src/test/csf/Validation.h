...
*/
//==============================================================================
#ifndef BLOCMATRIX_TEST_CSF_VALIDATION_H_INCLUDED
#define BLOCMATRIX_TEST_CSF_VALIDATION_H_INCLUDED
...
public:
    ...
    unwrap() const
    {
        // For the blocmatrixd implementation in which BCLValidation wraps
