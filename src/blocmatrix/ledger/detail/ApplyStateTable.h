...
#ifndef BLOCMATRIX_LEDGER_APPLYSTATETABLE_H_INCLUDED
#define BLOCMATRIX_LEDGER_APPLYSTATETABLE_H_INCLUDED
...
public:
    ...
    void
    destroyBMC (BMCAmount const& fee);

    // For debugging
    BMCAmount const& dropsDestroyed () const
    {
