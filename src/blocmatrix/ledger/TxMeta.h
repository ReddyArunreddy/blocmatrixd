...
#ifndef BLOCMATRIX_APP_TX_TRANSACTIONMETA_H_INCLUDED
#define BLOCMATRIX_APP_TX_TRANSACTIONMETA_H_INCLUDED
...
// VFALCO Move to blocmatrix/app/ledger/detail, rename to TxMeta
class TxMeta
{
public:
