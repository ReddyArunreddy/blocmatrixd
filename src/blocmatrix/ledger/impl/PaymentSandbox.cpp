        ...
        STAmount const& amount) const
{
    ...
    */
    ...
    if (isBMC(issuer) && adjustedAmt < beast::zero)
        // A calculated negative BMC balance is not an error case. Consider a
        // payment snippet that credits a large BMC amount and then debits the
...
PaymentSandbox::balanceChanges (ReadView const& view) const
{
    ...
    // get the change in BMC balance, Account == root, issuer == root, currency == BMC
...
BMCAmount PaymentSandbox::bmcDestroyed () const
{
