...
#ifndef BLOCMATRIX_LEDGER_VIEW_H_INCLUDED
#define BLOCMATRIX_LEDGER_VIEW_H_INCLUDED

#include <blocmatrix/ledger/ApplyView.h>
#include <blocmatrix/ledger/OpenView.h>
#include <blocmatrix/ledger/RawView.h>
...
// Return the account's liquid (not reserved) BMC.  Generally prefer
