...
#ifndef BLOCMATRIX_CORE_CONFIG_H_INCLUDED
#define BLOCMATRIX_CORE_CONFIG_H_INCLUDED

#include <blocmatrix/basics/BasicConfig.h>
#include <blocmatrix/basics/base_uint.h>
#include <blocmatrix/protocol/SystemParameters.h> // VFALCO Breaks levelization
#include <blocmatrix/beast/net/IPEndpoint.h>
...
public:
    ...
    std::vector<std::string>    IPS;                    // Peer IPs from blocmatrixd.cfg.
    std::vector<std::string>    IPS_FIXED;              // Fixed Peer IPs from blocmatrixd.cfg.
    std::vector<std::string>    SNTP_SERVERS;           // SNTP servers from blocmatrixd.cfg.
