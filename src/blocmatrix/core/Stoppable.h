...
#ifndef BLOCMATRIX_CORE_STOPPABLE_H_INCLUDED
#define BLOCMATRIX_CORE_STOPPABLE_H_INCLUDED

#include <blocmatrix/beast/core/LockFreeStack.h>
#include <blocmatrix/beast/utility/Journal.h>
#include <blocmatrix/core/Job.h>
#include <blocmatrix/core/ClosureCounter.h>
#include <atomic>
#include <chrono>
...
/** Provides an interface for starting and stopping.
    ...
    The form of the Stoppable tree in the blocmatrixd application evolves as
