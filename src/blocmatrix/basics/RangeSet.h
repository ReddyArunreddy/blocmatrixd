...
#ifndef BLOCMATRIX_BASICS_RANGESET_H_INCLUDED
#define BLOCMATRIX_BASICS_RANGESET_H_INCLUDED
...
void
save(Archive& ar,
    blocmatrix::ClosedInterval<T> const& ci,
...
template <class Archive, class T>
void
load(Archive& ar, blocmatrix::ClosedInterval<T>& ci, const unsigned int version)
{
    T low, up;
    ar >> low >> up;
    ci = blocmatrix::ClosedInterval<T>{low, up};
}

template <class Archive, class T>
void
serialize(Archive& ar,
    blocmatrix::ClosedInterval<T>& ci,
    const unsigned int version)
{
...
template <class Archive, class T>
void
save(Archive& ar, blocmatrix::RangeSet<T> const& rs, const unsigned int version)
{
...
template <class Archive, class T>
void
load(Archive& ar, blocmatrix::RangeSet<T>& rs, const unsigned int version)
{
    rs.clear();
...
template <class Archive, class T>
void
serialize(Archive& ar, blocmatrix::RangeSet<T>& rs, const unsigned int version)
{
