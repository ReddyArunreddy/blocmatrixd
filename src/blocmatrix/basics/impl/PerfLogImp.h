...
#ifndef BLOCMATRIX_BASICS_PERFLOGIMP_H
#define BLOCMATRIX_BASICS_PERFLOGIMP_H
    ...
    : public PerfLog, Stoppable
{
    ...
    Counters counters_ {blocmatrix::RPC::getHandlerNames(), JobTypes::instance()};
...
#endif //BLOCMATRIX_BASICS_PERFLOGIMP_H
