...
// On blocmatrixd shutdown, cancel and wait for the update thread
...
// This actually measures time since first use, instead of since blocmatrixd start.
...
UptimeClock::now()
{
    ...
    // Return the number of seconds since blocmatrixd start
