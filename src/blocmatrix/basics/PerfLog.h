...
#ifndef BLOCMATRIX_BASICS_PERFLOG_H
#define BLOCMATRIX_BASICS_PERFLOG_H
...
public:
    ...
    /**
     * Configuration from [perf] section of blocmatrixd.cfg.
     */
    struct Setup
    {
...
#endif //BLOCMATRIX_BASICS_PERFLOG_H
