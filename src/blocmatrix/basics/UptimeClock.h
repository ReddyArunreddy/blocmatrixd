...
#ifndef BLOCMATRIX_BASICS_UPTIMETIMER_H_INCLUDED
#define BLOCMATRIX_BASICS_UPTIMETIMER_H_INCLUDED
...
public:
    ...
    static time_point now();  // seconds since blocmatrixd program start
