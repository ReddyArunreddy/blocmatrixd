...
#ifndef BLOCMATRIX_BASICS_BASE_UINT_H_INCLUDED
#define BLOCMATRIX_BASICS_BASE_UINT_H_INCLUDED

#include <blocmatrix/basics/strHex.h>
#include <blocmatrix/basics/hardened_hash.h>
#include <blocmatrix/beast/cxx17/type_traits.h>
...
template <std::size_t Bits, class Tag>
struct is_uniquely_represented<blocmatrix::base_uint<Bits, Tag>>
