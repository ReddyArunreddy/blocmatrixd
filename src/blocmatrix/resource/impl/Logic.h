...
#ifndef BLOCMATRIX_RESOURCE_LOGIC_H_INCLUDED
#define BLOCMATRIX_RESOURCE_LOGIC_H_INCLUDED

#include <blocmatrix/resource/Fees.h>
#include <blocmatrix/resource/Gossip.h>
#include <blocmatrix/resource/impl/Import.h>
