...
#ifndef BLOCMATRIX_RESOURCE_CONSUMER_H_INCLUDED
#define BLOCMATRIX_RESOURCE_CONSUMER_H_INCLUDED

#include <blocmatrix/resource/Charge.h>
#include <blocmatrix/resource/Disposition.h>
