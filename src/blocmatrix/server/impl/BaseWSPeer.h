...
#ifndef BLOCMATRIX_SERVER_BASEWSPEER_H_INCLUDED
#define BLOCMATRIX_SERVER_BASEWSPEER_H_INCLUDED

#include <blocmatrix/basics/safe_cast.h>
#include <blocmatrix/server/impl/BasePeer.h>
#include <blocmatrix/server/impl/LowestLayer.h>
...
fail(error_code ec, String const& what)
{
        ...
        ec != boost::asio::error::operation_aborted)
    {
        ...
        JLOG(this->j_.trace()) <<
            what << ": " << ec.message();
        blocmatrix::get_lowest_layer(impl().ws_).close(ec);
    }
}
