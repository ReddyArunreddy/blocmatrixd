...
#ifndef BLOCMATRIX_SERVER_BASEHTTPPEER_H_INCLUDED
#define BLOCMATRIX_SERVER_BASEHTTPPEER_H_INCLUDED
...
#include <blocmatrix/beast/asio/ssl_error.h> // for is_short_read?
