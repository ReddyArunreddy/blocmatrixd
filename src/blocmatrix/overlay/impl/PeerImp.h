...
#ifndef BLOCMATRIX_OVERLAY_PEERIMP_H_INCLUDED
#define BLOCMATRIX_OVERLAY_PEERIMP_H_INCLUDED

#include <blocmatrix/app/consensus/BCLCxPeerPos.h>
#include <blocmatrix/basics/Log.h>
#include <blocmatrix/basics/RangeSet.h>
#include <blocmatrix/beast/asio/waitable_timer.h>
#include <blocmatrix/beast/utility/WrappedSink.h>
#include <blocmatrix/overlay/impl/ProtocolMessage.h>
#include <blocmatrix/overlay/impl/OverlayImpl.h>
...
public:
    ...
    */
    ...
    enum class State
    {
        ...
        /** Running the Blocmatrix protocol actively */
        ,active
    };
...
public:
    ...
    */
    ...
    /** Return the version of blocmatrixd that the peer is running, if reported. */
    std::string
    getVersion() const;
