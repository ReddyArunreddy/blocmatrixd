...
#ifndef BLOCMATRIX_OVERLAY_PROTOCOLMESSAGE_H_INCLUDED
#define BLOCMATRIX_OVERLAY_PROTOCOLMESSAGE_H_INCLUDED

#include <blocmatrix/protocol/messages.h>
#include <blocmatrix/overlay/Message.h>
#include <blocmatrix/overlay/impl/ZeroCopyStream.h>
