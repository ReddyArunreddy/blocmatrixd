...
#include <blocmatrix/overlay/impl/ConnectAttempt.h>
#include <blocmatrix/overlay/impl/PeerImp.h>
#include <blocmatrix/peerfinder/make_Manager.h>
#include <blocmatrix/rpc/json_body.h>
#include <blocmatrix/rpc/handlers/GetCounts.h>
...
OverlayImpl::onPrepare()
{
    ...
    // Add the ips_fixed from the blocmatrixd.cfg file
...
/** The number of active peers on the network
    ...
    and are running the Blocmatrix protocol.
*/
std::size_t
OverlayImpl::size()
{
...
OverlayImpl::getServerInfo()
{
    ...
    if (server_info.isMember(jss::validated_ledger))
    {
        ...
        validated_ledger.removeMember(jss::reserve_base_bmc);
        validated_ledger.removeMember(jss::reserve_inc_bmc);
    }
