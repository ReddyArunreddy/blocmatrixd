...
Json::Value doBlocmatrixPathFind (RPC::Context& context)
{
        ...
        ! context.params.isMember(jss::ledger_hash))
    {
        ...
        //
        // 1. We're running doBlocmatrixPathFind() due to a call to
        //    blocmatrix_path_find.  doBlocmatrixPathFind() is currently running
        //    inside of a JobQueue::Coro using a JobQueue thread.
        //
        // 2. doBlocmatrixPathFind's call to makeLegacyPathRequest() enqueues the
        ...
        // blocmatrixd source code) shutting down the application.  The code to
