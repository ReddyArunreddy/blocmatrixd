...
#ifndef BLOCMATRIX_RPC_HANDLERS_HANDLERS_H_INCLUDED
#define BLOCMATRIX_RPC_HANDLERS_HANDLERS_H_INCLUDED

#include <blocmatrix/rpc/handlers/LedgerHandler.h>
...
Json::Value doNoBlocmatrixCheck         (RPC::Context&);
...
Json::Value doBlocmatrixPathFind        (RPC::Context&);
