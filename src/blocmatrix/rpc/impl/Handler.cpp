...
#include <blocmatrix/rpc/handlers/Version.h>
...
Handler const handlerArray[] {
    ...
    {   "noblocmatrix_check",       byRef (&doNoBlocmatrixCheck),       Role::USER,  NO_CONDITION  },
...
//      {   "profile",              byRef (&doProfile),             Role::USER,  NEEDS_CURRENT_LEDGER  },
    ...
    {   "blocmatrix_path_find",     byRef (&doBlocmatrixPathFind),      Role::USER,  NO_CONDITION  },
