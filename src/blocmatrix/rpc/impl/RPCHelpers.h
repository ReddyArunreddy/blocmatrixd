...
#ifndef BLOCMATRIX_RPC_RPCHELPERS_H_INCLUDED
#define BLOCMATRIX_RPC_RPCHELPERS_H_INCLUDED
...
#include <blocmatrix/rpc/Status.h>
...
boost::optional<Seed>
parseBlocmatrixLibSeed(Json::Value const& params);
