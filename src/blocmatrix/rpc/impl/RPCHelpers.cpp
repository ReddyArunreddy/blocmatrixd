...
boost::optional<Seed>
parseBlocmatrixLibSeed(Json::Value const& value)
{
    // blocmatrix-lib encodes seed used to generate an Ed25519 wallet in a
    // non-standard way. While blocmatrixd never encode seeds that way, we
...
keypairForSignature(Json::Value const& params, Json::Value& error)
{
    ...
    {
        seed = RPC::parseBlocmatrixLibSeed(params[secretType]);
