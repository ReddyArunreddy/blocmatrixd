...
#ifndef BLOCMATRIX_RPC_TUNING_H_INCLUDED
#define BLOCMATRIX_RPC_TUNING_H_INCLUDED
...
/** Limits for the no_blocmatrix_check command. */
static LimitRange const noBlocmatrixCheck = {10, 300, 400};
