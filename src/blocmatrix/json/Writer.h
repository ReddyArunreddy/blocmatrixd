...
#ifndef BLOCMATRIX_JSON_WRITER_H_INCLUDED
#define BLOCMATRIX_JSON_WRITER_H_INCLUDED

#include <blocmatrix/basics/contract.h>
#include <blocmatrix/basics/ToString.h>
...
{
    if (! condition)
        blocmatrix::Throw<std::logic_error> (message);
}
