...
#ifndef BLOCMATRIX_PROTOCOL_JSONFIELDS_H_INCLUDED
#define BLOCMATRIX_PROTOCOL_JSONFIELDS_H_INCLUDED
...
JSS ( BlocmatrixState );                // ledger type.
...
JSS ( alternatives );               // out: PathRequest, BlocmatrixPathFind
...
JSS ( base_fee_bmc );               // out: NetworkOPs
...
JSS ( destination_account );        // in: PathRequest, BlocmatrixPathFind, account_lines
                                    // out: AccountChannels
JSS ( destination_amount );         // in: PathRequest, BlocmatrixPathFind
JSS ( destination_currencies );     // in: PathRequest, BlocmatrixPathFind
...
JSS ( issuer );                     // in: BlocmatrixPathFind, Subscribe,
...
JSS ( ledger_hash );                // in: RPCHelpers, LedgerRequest,
                                    //     BlocmatrixPathFind, TransactionEntry,
                                    //     handlers/Ledger
...
JSS ( no_blocmatrix );                  // out: AccountLines
JSS ( no_blocmatrix_peer );             // out: AccountLines
...
JSS ( paths );                      // in: BlocmatrixPathFind
JSS ( paths_canonical );            // out: BlocmatrixPathFind
JSS ( paths_computed );             // out: PathRequest, BlocmatrixPathFind
JSS ( payment_channel );            // in: LedgerEntry
JSS ( peer );                       // in: AccountLines
JSS ( peer_authorized );            // out: AccountLines
JSS ( peer_id );                    // out: BCLCxPeerPos
...
JSS ( reserve_base_bmc );           // out: NetworkOPs
JSS ( reserve_inc );                // out: NetworkOPs
JSS ( reserve_inc_bmc );            // out: NetworkOPs
JSS ( response );                   // websocket
JSS ( result );                     // RPC
JSS ( blocmatrix_lines );               // out: NetworkOPs
JSS ( blocmatrix_state );               // in: LedgerEntr
JSS ( blocmatribmcc );                  // blocmatrix RPC version
JSS ( role );                       // out: Ping.cpp
JSS ( rpc );
JSS ( rt_accounts );                // in: Subscribe, Unsubscribe
JSS ( running_duration_us );
JSS ( sanity );                     // out: PeerImp
JSS ( search_depth );               // in: BlocmatrixPathFind
...
JSS ( send_max );                   // in: PathRequest, BlocmatrixPathFind
...
JSS ( source_account );             // in: PathRequest, BlocmatrixPathFind
JSS ( source_amount );              // in: PathRequest, BlocmatrixPathFind
JSS ( source_currencies );          // in: PathRequest, BlocmatrixPathFind
...
JSS ( transaction_hash );           // out: BCLCxPeerPos, LedgerToJson
