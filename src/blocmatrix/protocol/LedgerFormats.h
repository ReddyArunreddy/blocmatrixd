...
#ifndef BLOCMATRIX_PROTOCOL_LEDGERFORMATS_H_INCLUDED
#define BLOCMATRIX_PROTOCOL_LEDGERFORMATS_H_INCLUDED

#include <blocmatrix/protocol/KnownFormats.h>
...
enum LedgerEntryType
{
    ...
    */
    ...
    // Simple unidirection bmc channel
    ltPAYCHAN           = 'x',
...
enum LedgerSpecificFlags
{
    ...
    lsfDisallowBMC      = 0x00080000,   // True, to disallow sending BMC.
    lsfDisableMaster    = 0x00100000,   // True, force regular key
    lsfNoFreeze         = 0x00200000,   // True, cannot freeze blocmatrix states
    lsfGlobalFreeze     = 0x00400000,   // True, all assets frozen
    lsfDefaultBlocmatrix    = 0x00800000,   // True, trust lines allow rippling by default
    ...
    lsfLowNoBlocmatrix      = 0x00100000,
    lsfHighNoBlocmatrix     = 0x00200000,
