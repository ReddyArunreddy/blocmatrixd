...
#ifndef BLOCMATRIX_PROTOCOL_STAMOUNT_H_INCLUDED
#define BLOCMATRIX_PROTOCOL_STAMOUNT_H_INCLUDED

#include <blocmatrix/basics/chrono.h>
#include <blocmatrix/basics/LocalValue.h>
...
private:
    ...
    bool mIsNative;      // A shorthand for isBMC(mIssue).
    bool mIsNegative;
...
public:
    ...
    STAmount (BMCAmount const& amount);
...
public:
    ...
    STAmount& operator= (BMCAmount const& amount)
    {
...
// IOUAmount and BMCAmount define toSTAmount, defining this
...
inline bool isBMC(STAmount const& amount)
{
    return isBMC (amount.issue().currency);
}
