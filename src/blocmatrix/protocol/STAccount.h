...
#ifndef BLOCMATRIX_PROTOCOL_STACCOUNT_H_INCLUDED
#define BLOCMATRIX_PROTOCOL_STACCOUNT_H_INCLUDED
...
private:
    ...
    // overhead in a blocmatrix::uint160.  However, so the serialized format of the
