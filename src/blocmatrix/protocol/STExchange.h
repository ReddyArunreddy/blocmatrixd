...
#ifndef BLOCMATRIX_PROTOCOL_STEXCHANGE_H_INCLUDED
#define BLOCMATRIX_PROTOCOL_STEXCHANGE_H_INCLUDED

#include <blocmatrix/basics/Buffer.h>
...
#include <blocmatrix/basics/Blob.h>
