...
#ifndef BLOCMATRIX_PROTOCOL_TXFLAGS_H_INCLUDED
#define BLOCMATRIX_PROTOCOL_TXFLAGS_H_INCLUDED
...
const std::uint32_t asfDefaultBlocmatrix       = 8;
...
// Payment flags:
const std::uint32_t tfNoBlocmatrixDirect       = 0x00010000;
const std::uint32_t tfPartialPayment       = 0x00020000;
const std::uint32_t tfLimitQuality         = 0x00040000;
const std::uint32_t tfPaymentMask          = ~ (tfUniversal | tfPartialPayment | tfLimitQuality | tfNoBlocmatrixDirect);

// TrustSet flags:
const std::uint32_t tfSetfAuth             = 0x00010000;
const std::uint32_t tfSetNoBlocmatrix          = 0x00020000;
const std::uint32_t tfClearNoBlocmatrix        = 0x00040000;
const std::uint32_t tfSetFreeze            = 0x00100000;
const std::uint32_t tfClearFreeze          = 0x00200000;
const std::uint32_t tfTrustSetMask         = ~ (tfUniversal | tfSetfAuth | tfSetNoBlocmatrix | tfClearNoBlocmatrix
