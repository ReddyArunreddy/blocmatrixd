...
#ifndef BLOCMATRIX_PROTOCOL_ISSUE_H_INCLUDED
#define BLOCMATRIX_PROTOCOL_ISSUE_H_INCLUDED
...
/** Returns an asset specifier that represents BMC. */
inline Issue const& bmcIssue ()
{
    static Issue issue {bmcCurrency(), bmcAccount()};
    return issue;
}
