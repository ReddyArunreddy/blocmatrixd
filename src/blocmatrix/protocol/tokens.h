...
#ifndef BLOCMATRIX_PROTOCOL_TOKENS_H_INCLUDED
#define BLOCMATRIX_PROTOCOL_TOKENS_H_INCLUDED
...
// Facilities for converting Blocmatrix tokens
// to and from their human readable strings

/*  Base-58 encode a Blocmatrix Token

    Blocmatrix Tokens have a one-byte prefx indicating
