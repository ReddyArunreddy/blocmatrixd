...
#ifndef BLOCMATRIX_PROTOCOL_DIGEST_H_INCLUDED
#define BLOCMATRIX_PROTOCOL_DIGEST_H_INCLUDED

#include <blocmatrix/basics/base_uint.h>
#include <blocmatrix/beast/crypto/ripemd.h>
#include <blocmatrix/beast/crypto/sha2.h>
#include <blocmatrix/beast/hash/endian.h>
#include <algorithm>
#include <array>
