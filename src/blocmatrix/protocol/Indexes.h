...
#ifndef BLOCMATRIX_PROTOCOL_INDEXES_H_INCLUDED
#define BLOCMATRIX_PROTOCOL_INDEXES_H_INCLUDED

#include <blocmatrix/protocol/Keylet.h>
...
uint256
getBlocmatrixStateIndex (AccountID const& a, AccountID const& b, Currency const& currency);

uint256
getBlocmatrixStateIndex (AccountID const& a, Issue const& issue);
