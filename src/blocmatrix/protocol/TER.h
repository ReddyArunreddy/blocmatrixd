...
#ifndef BLOCMATRIX_PROTOCOL_TER_H_INCLUDED
#define BLOCMATRIX_PROTOCOL_TER_H_INCLUDED
...
enum TEMcodes : TERUnderlyingType
{
    ...
    temBAD_PATH_LOOP,
    temBAD_REGKEY,
    temBAD_SEND_BMC_LIMIT,
    temBAD_SEND_BMC_MAX,
    temBAD_SEND_BMC_NO_DIRECT,
    temBAD_SEND_BMC_PARTIAL,
    temBAD_SEND_BMC_PATHS,
    temBAD_SEQUENCE,
    temBAD_SIGNATURE,
    temBAD_SRC_ACCOUNT,
...
enum TERcodes : TERUnderlyingType
{
    ...
    terNO_BLOCMATRIX,        // Rippling not allowed
...
enum TECcodes : TERUnderlyingType
{
    ...
    // 100 .. 159 C
    //   Claim fee only (blocmatrix transaction with no good paths, pay to
