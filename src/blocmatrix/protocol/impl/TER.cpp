...
transResults()
{
    ...
    results
    {
        ...
        { tecNO_DST,                 { "tecNO_DST",                "Destination does not exist. Send BMC to create it."                            } },
        { tecNO_DST_INSUF_BMC,       { "tecNO_DST_INSUF_BMC",      "Destination does not exist. Too little BMC sent to create it."                 } },
        ...
        { tecUNFUNDED_ADD,           { "tecUNFUNDED_ADD",          "Insufficient BMC balance for WalletAdd."                                       } },
        { tecUNFUNDED_OFFER,         { "tecUNFUNDED_OFFER",        "Insufficient balance to fund created offer."                                   } },
        { tecUNFUNDED_PAYMENT,       { "tecUNFUNDED_PAYMENT",      "Insufficient BMC balance to send."                                             } },
        ...
        { temBAD_FEE,                { "temBAD_FEE",               "Invalid fee, negative or not BMC."                                             } },
        ...
        { temBAD_SEND_BMC_LIMIT,     { "temBAD_SEND_BMC_LIMIT",    "Malformed: Limit quality is not allowed for BMC to BMC."                       } },
        { temBAD_SEND_BMC_MAX,       { "temBAD_SEND_BMC_MAX",      "Malformed: Send max is not allowed for BMC to BMC."                            } },
        { temBAD_SEND_BMC_NO_DIRECT, { "temBAD_SEND_BMC_NO_DIRECT","Malformed: No Blocmatrix direct is not allowed for BMC to BMC."                    } },
        { temBAD_SEND_BMC_PARTIAL,   { "temBAD_SEND_BMC_PARTIAL",  "Malformed: Partial payment is not allowed for BMC to BMC."                     } },
        { temBAD_SEND_BMC_PATHS,     { "temBAD_SEND_BMC_PATHS",    "Malformed: Paths are not allowed for BMC to BMC."                              } },
        ...
        { temBLOCMATRIX_EMPTY,           { "temBLOCMATRIX_EMPTY",          "PathSet with no paths."                                                        } },
        ...
        { terNO_BLOCMATRIX,              { "terNO_BLOCMATRIX",             "Path does not permit rippling."                                                } },
