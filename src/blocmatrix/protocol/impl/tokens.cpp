...
static char blocmatrixAlphabet[] =
...
{
    return encodeToken(type, token, size, blocmatrixAlphabet);
}
...
/*  Base58 decode a Blocmatrix token
...
static InverseAlphabet blocmatrixInverse(blocmatrixAlphabet);
...
{
    return decodeBase58Token(s, type, blocmatrixInverse);
}
