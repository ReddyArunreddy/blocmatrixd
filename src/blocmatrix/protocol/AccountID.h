...
#ifndef BLOCMATRIX_PROTOCOL_ACCOUNTID_H_INCLUDED
#define BLOCMATRIX_PROTOCOL_ACCOUNTID_H_INCLUDED

#include <blocmatrix/protocol/tokens.h>
...
/** A special account that's used as the "issuer" for BMC. */
AccountID const&
bmcAccount();
...
/** Caches the base58 representations of AccountIDs
    ...
    justify having a cache. In the future, blocmatrixd should
...
public:
    ...
    /** Return blocmatrix::toBase58 for the AccountID
...
template <>
struct hash <blocmatrix::AccountID> : blocmatrix::AccountID::hasher
{
