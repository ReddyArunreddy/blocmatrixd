...
/** Get the current BlocmatrixLineCache, updating it if necessary.
    Get the correct ledger to use.
*/
std::shared_ptr<BlocmatrixLineCache>
    ...
    bool authoritative)
{
    ...
    {
        mLineCache = std::make_shared<BlocmatrixLineCache> (ledger);
    }
    return mLineCache;
}
                              ...
                              Job::CancelCallback shouldCancel)
{
    ...
    std::shared_ptr<BlocmatrixLineCache> cache;
...
// Make an old-style blocmatrix_path_find request
Json::Value
...
PathRequests::doLegacyPathRequest (
        ...
        Json::Value const& request)
{
    auto cache = std::make_shared<BlocmatrixLineCache> (inLedger);
