...
#ifndef BLOCMATRIX_APP_PATHS_BLOCMATRIXCALC_H_INCLUDED
#define BLOCMATRIX_APP_PATHS_BLOCMATRIXCALC_H_INCLUDED
...
/** BlocmatrixCalc calculates the quality of a payment path.
...
private:
    ...
    TER blocmatrixCalculate (detail::FlowDebugInfo* flowDebugInfo=nullptr);
