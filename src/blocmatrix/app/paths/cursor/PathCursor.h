...
#ifndef BLOCMATRIX_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
#define BLOCMATRIX_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
...
public:
    PathCursor(
        ...
        NodeIndex nodeIndex = 0)
            : blocmatrixCalc_(blocmatrixCalc),
...
private:
    ...
    {
        return {blocmatrixCalc_, pathState_, multiQuality_, j_, nodeIndex_ + delta};
    }
    ...
    */
    ...
    BlocmatrixCalc& blocmatrixCalc_;
