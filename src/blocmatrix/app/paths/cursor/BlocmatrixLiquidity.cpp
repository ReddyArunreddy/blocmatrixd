    ...
    std::uint64_t& uRateMax)
{
    ...
    if (qualityIn >= qualityOut)
    {
        ...
        JLOG (blocmatrixCalc.j_.trace()) << "blocmatrixLiquidity: No fees";
    ...
    else
    {
        ...
        JLOG (blocmatrixCalc.j_.trace()) << "blocmatrixLiquidity: Fee";
        ...
        if (!uRateMax || uRate <= uRateMax)
        {
            ...
            else
            {
                ...
                JLOG (blocmatrixCalc.j_.trace())
                    << "blocmatrixLiquidity:4: saCurReq=" << saCurReq;
...
quality_in (
    ...
    Currency const& currency)
{
    return blocmatrixQuality (view, uToAccountID, uFromAccountID, currency,
