...
#ifndef BLOCMATRIX_APP_PATHS_PATHSTATE_H_INCLUDED
#define BLOCMATRIX_APP_PATHS_PATHSTATE_H_INCLUDED

#include <blocmatrix/app/paths/Node.h>
#include <blocmatrix/app/paths/Types.h>
...
class PathState : public CountedObject <PathState>
{
  public:
    ...
    TER checkNoBlocmatrix (AccountID const& destinationAccountID,
