...
#ifndef BLOCMATRIX_APP_PATHS_PATHREQUEST_H_INCLUDED
#define BLOCMATRIX_APP_PATHS_PATHREQUEST_H_INCLUDED
...
#include <blocmatrix/net/InfoSub.h>
...
public:
    ...
    // blocmatrix_path_find semantics
    ...
    std::pair<bool, Json::Value> doCreate (
        std::shared_ptr<BlocmatrixLineCache> const&,
        Json::Value const&);
    ...
    // update jvStatus
    Json::Value doUpdate (
        std::shared_ptr<BlocmatrixLineCache> const&, bool fast);
...
private:
    ...
    bool isValid (std::shared_ptr<BlocmatrixLineCache> const& crCache);
    void setValid ();

    std::unique_ptr<Pathfinder> const&
    getPathFinder(std::shared_ptr<BlocmatrixLineCache> const&,
    ...
    */
    bool
    findPaths (std::shared_ptr<BlocmatrixLineCache> const&, int const, Json::Value&);
