...
#ifndef BLOCMATRIX_APP_PATHS_PATHFINDER_H_INCLUDED
#define BLOCMATRIX_APP_PATHS_PATHFINDER_H_INCLUDED

#include <blocmatrix/app/ledger/Ledger.h>
#include <blocmatrix/app/paths/BlocmatrixLineCache.h>
#include <blocmatrix/core/LoadEvent.h>
#include <blocmatrix/protocol/STAmount.h>
#include <blocmatrix/protocol/STPathSet.h>

namespace blocmatrix {

/** Calculates payment paths.

    The @ref BlocmatrixCalc determines the quality of the found paths.
...
public:
    ...
    */
    ...
    enum NodeType
    {
        ...
        nt_BMC_BOOK,   // The order book from this currency to BMC.
    ...
    enum PaymentType
    {
        ...
        pt_BMC_to_nonBMC,
        pt_nonBMC_to_BMC,
        pt_nonBMC_to_same,   // Destination currency is the same as source.
        pt_nonBMC_to_nonBMC  // Destination currency is NOT the same as source.
    };
...
private:
    ...
    // set the "no blocmatrix" flag on the link?
    bool isNoBlocmatrixOut (STPath const& currentPath);

    // Is the "no blocmatrix" flag set from one account to another?
    bool isNoBlocmatrix (
    ...
    std::shared_ptr<BlocmatrixLineCache> mRLCache;
