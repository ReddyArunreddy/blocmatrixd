...
#ifndef BLOCMATRIX_APP_PATHS_PATHREQUESTS_H_INCLUDED
#define BLOCMATRIX_APP_PATHS_PATHREQUESTS_H_INCLUDED
...
public:
    ...
    std::shared_ptr<BlocmatrixLineCache> getLineCache (
...
private:
    ...
    // Use a BlocmatrixLineCache
    std::shared_ptr<BlocmatrixLineCache>         mLineCache;
