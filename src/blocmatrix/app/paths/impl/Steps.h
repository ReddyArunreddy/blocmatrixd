...
#ifndef BLOCMATRIX_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
#define BLOCMATRIX_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
...
/**
   ...
   There are five concrete step classes:
     ...
     BookStepIX is an IOU/BMC offer book
     BookStepXI is an BMC/IOU offer book
     BMCEndpointStep is the source or destination account for BMC
...
public:
    ...
    */
    ...
    // For BMC endpoints, one of src or dst will be the root account
...
/*
   ...
   @param path Liquidity sources to use for this strand of the payment. The path
               ...
               accounts to blocmatrix through.
...
struct StrandContext
{
    ...
    /** The previous step in the strand. Needed to check the no blocmatrix
        constraint
     */
