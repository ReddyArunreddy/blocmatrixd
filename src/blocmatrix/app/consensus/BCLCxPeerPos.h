...
#ifndef BLOCMATRIX_APP_CONSENSUS_BCLCXPEERPOS_H_INCLUDED
#define BLOCMATRIX_APP_CONSENSUS_BCLCXPEERPOS_H_INCLUDED
...
/** A peer's signed, proposed position for use in BCLConsensus.
