...
#ifndef BLOCMATRIX_APP_CONSENSUS_BCLCONSENSUS_H_INCLUDED
#define BLOCMATRIX_APP_CONSENSUS_BCLCONSENSUS_H_INCLUDED

#include <blocmatrix/app/consensus/BCLCxLedger.h>
#include <blocmatrix/app/consensus/BCLCxPeerPos.h>
#include <blocmatrix/app/consensus/BCLCxTx.h>
#include <blocmatrix/app/consensus/BCLCensorshipDetector.h>
#include <blocmatrix/app/misc/FeeVote.h>
#include <blocmatrix/basics/CountedObject.h>
...
#include <blocmatrix/overlay/Message.h>
#include <blocmatrix/protocol/BlocmatrixLedgerHash.h>
#include <blocmatrix/protocol/STValidation.h>
...
/** Manages the generic consensus algorithm for use by the BCL.
*/
class BCLConsensus
{
    ...
    class Adaptor
    {
        ...
        BCLCensorshipDetector<TxID, LedgerIndex> censorshipDetector_;

    public:
        using Ledger_t = BCLCxLedger;
        using NodeID_t = NodeID;
        using NodeKey_t = PublicKey;
        using TxSet_t = BCLTxSet;
        using PeerPosition_t = BCLCxPeerPos;
        ...
        */
        bool
        preStartRound(BCLCxLedger const & prevLedger);
    ...
    private:
        ...
        // methods and since BCLConsensus::consensus_ should only be accessed
        ...
        */
         ...
         */
        void
        share(BCLCxPeerPos const& peerPos);
       ...
       */
        ...
        acquireTxSet(BCLTxSet::ID const& setId);
        ...
        */
        std::size_t
        proposersFinished(BCLCxLedger const & ledger, LedgerHash const& h) const;
        ...
        */
        void
        propose(BCLCxPeerPos::Proposal const& proposal);
      ...
      */
        ...
        */
        void
        validate(BCLCxLedger const& ledger, BCLTxSet const& txns, bool proposing);
    };
...
public:
    ...
    BCLConsensus(BCLConsensus const&) = delete;

    BCLConsensus&
    operator=(BCLConsensus const&) = delete;
    ...
    */
    ...
    void
    gotTxSet(NetClock::time_point const& now, BCLTxSet const& txSet);
