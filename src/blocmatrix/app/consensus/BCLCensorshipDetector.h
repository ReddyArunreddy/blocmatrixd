...
#ifndef BLOCMATRIX_APP_CONSENSUS_BCLCENSORSHIPDETECTOR_H_INCLUDED
#define BLOCMATRIX_APP_CONSENSUS_BCLCENSORSHIPDETECTOR_H_INCLUDED

#include <blocmatrix/basics/algorithm.h>
