...
#ifndef BLOCMATRIX_APP_TX_TRANSACTOR_H_INCLUDED
#define BLOCMATRIX_APP_TX_TRANSACTOR_H_INCLUDED
...
protected:
    ...
    AccountID     account_;
    BMCAmount     mPriorBalance;  // Balance before fees.
    BMCAmount     mSourceBalance; // Balance after fees.
...
protected:
    ...
    /** Compute the minimum fee required to process a transaction
        ...
        @param baseFee The base fee of a candidate transaction
            @see blocmatrix::calculateBaseFee
