...
#ifndef BLOCMATRIX_APP_BOOK_OFFER_H_INCLUDED
#define BLOCMATRIX_APP_BOOK_OFFER_H_INCLUDED
...
template<>
inline
void TOffer<IOUAmount, BMCAmount>::setFieldAmounts ()
{
    m_entry->setFieldAmount (sfTakerPays, toSTAmount(m_amounts.in, issIn_));
...
template<>
inline
void TOffer<BMCAmount, IOUAmount>::setFieldAmounts ()
{
