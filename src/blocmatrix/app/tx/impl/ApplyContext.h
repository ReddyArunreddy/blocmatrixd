...
#ifndef BLOCMATRIX_TX_APPLYCONTEXT_H_INCLUDED
#define BLOCMATRIX_TX_APPLYCONTEXT_H_INCLUDED
...
public:
     ...
     */
    TER
    checkInvariants(TER const result, BMCAmount const fee);
...
private:
    ...
    TER
    checkInvariantsHelper(TER const result, BMCAmount const fee, std::index_sequence<Is...>);
