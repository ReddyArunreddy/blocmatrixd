...
#ifndef BLOCMATRIX_APP_MISC_NETWORKOPS_H_INCLUDED
#define BLOCMATRIX_APP_MISC_NETWORKOPS_H_INCLUDED
...
/** Provides server functionality for clients.
    ...
    blocmatrixd / NetworkOPs. However, client software connecting to non-local
    instances of blocmatrixd will need to be hardened to protect against hostile
...
public:
    ...
    virtual void processTrustedProposal (BCLCxPeerPos peerPos,
