...
#ifndef BLOCMATRIX_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
#define BLOCMATRIX_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
...
#include <blocmatrix/nodestore/DatabaseRotating.h>
...
private:
    ...
    std::string const dbPrefix_ = "blocmatrixdb";
...
private:
    ...
    // If blocmatrixd is not healthy, defer rotate-delete.
