...
#ifndef BLOCMATRIX_APP_MISC_VALIDATORLIST_H_INCLUDED
#define BLOCMATRIX_APP_MISC_VALIDATORLIST_H_INCLUDED
...
/**
    ...
    This class manages the set of validation public keys the local blocmatrixd node
