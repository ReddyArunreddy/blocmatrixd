...
#ifndef BLOCMATRIX_APP_MISC_MANIFEST_H_INCLUDED
#define BLOCMATRIX_APP_MISC_MANIFEST_H_INCLUDED
...
/*
    ...
    EVERY blocmatrixd needs to have its config updated with the new public keys, and
    ...
    received from blocmatrixd peers.
    ...
    signed by the master key.  When a blocmatrixd peer receives the new manifest,
