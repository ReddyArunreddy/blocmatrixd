...
#include <blocmatrix/beast/clock/basic_seconds_clock.h>
#include <blocmatrix/beast/core/CurrentThreadName.h>
...
void printHelp (const po::options_description& desc)
{
    std::cerr
        ...
        << "Commands: \n"
           ...
           "     random\n"
           "     blocmatrix ...\n"
           "     blocmatrix_path_find <json> [<ledger>]\n"
    ...
    char** argv)
{
    ...
    using namespace blocmatrix::test;

    blocmatrix::test::envUseIPv4 = (! ipv6);
...
int run (int argc, char** argv)
{
    ...
    beast::setCurrentThreadName ("blocmatrixd: main");
    ...
    {
        std::cerr << "blocmatrixd: Incorrect command line syntax." << std::endl;
    ...
    else
    {
        if (vm.count("unittest-jobs"))
        {
            ...
            std::cerr << "blocmatrixd: '--unittest-jobs' specified without '--unittest'.\n";
    ...
    beast::setCurrentThreadName ("blocmatrixd: rpc");
...
int main (int argc, char** argv)
{
    ...
    blocmatrix::sha512_deprecatedMSVCWorkaround();
#endif
    ...
    static_assert (gccver >= 50100,
        "GCC version 5.1.0 or later is required to compile blocmatrixd.");
#endif

    atexit(&google::protobuf::ShutdownProtobufLibrary);

    auto const result (blocmatrix::run (argc, argv));
