...
#include <blocmatrix/core/DatabaseCon.h>
#include <blocmatrix/app/consensus/BCLValidations.h>
#include <blocmatrix/app/main/DBInit.h>
#include <blocmatrix/app/main/BasicApp.h>
#include <blocmatrix/app/main/Tuning.h>
...
#include <blocmatrix/app/ledger/PendingSaves.h>
...
#include <blocmatrix/app/main/NodeIdentity.h>
#include <blocmatrix/app/main/NodeStoreScheduler.h>
...
#include <blocmatrix/beast/asio/io_latency_probe.h>
...
public:
    ...
    {
    #if BLOCMATRIX_SINGLE_IO_SERVICE_THREAD
        return 1;
    #else
    ...
    BCLValidations& getValidations () override
    {
        return mValidations;
    }
            ...
            if (freeSpace < megabytes(512))
            {
                JLOG(m_journal.fatal())
                    << "Free SQLite space for transaction db is less than "
                       "512MB. To fix this, blocmatrixd must be executed with the "
