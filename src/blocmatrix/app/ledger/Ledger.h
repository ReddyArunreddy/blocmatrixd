...
#ifndef BLOCMATRIX_APP_LEDGER_LEDGER_H_INCLUDED
#define BLOCMATRIX_APP_LEDGER_LEDGER_H_INCLUDED

#include <blocmatrix/ledger/TxMeta.h>
#include <blocmatrix/ledger/View.h>
#include <blocmatrix/ledger/CachedView.h>
...
public:
    ...
    /** Create the Genesis ledger.
        ...
        The account has an BMC balance equal to the total amount
        of BMC in the system. No more BMC than the amount which
    ...
    */
    ...
    void
    rawDestroyBMC (BMCAmount const& fee) override
    {
        info_.drops -= fee;
    }
