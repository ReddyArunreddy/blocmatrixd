...
#ifndef BLOCMATRIX_NODESTORE_DATABASE_H_INCLUDED
#define BLOCMATRIX_NODESTORE_DATABASE_H_INCLUDED

#include <blocmatrix/basics/TaggedCache.h>
#include <blocmatrix/basics/KeyCache.h>
#include <blocmatrix/core/Stoppable.h>
#include <blocmatrix/nodestore/Backend.h>
#include <blocmatrix/nodestore/impl/Tuning.h>
#include <blocmatrix/nodestore/Scheduler.h>
...
private:
    ...
    // The default is 32570 to match the BMC ledger network's earliest
    // allowed sequence. Alternate networks may set this value.
    std::uint32_t earliestSeq_ {BMC_LEDGER_EARLIEST_SEQ};
