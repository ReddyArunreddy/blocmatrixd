...
#ifndef BLOCMATRIX_NODESTORE_DATABASESHARDIMP_H_INCLUDED
#define BLOCMATRIX_NODESTORE_DATABASESHARDIMP_H_INCLUDED

#include <blocmatrix/nodestore/DatabaseShard.h>
#include <blocmatrix/nodestore/impl/Shard.h>
