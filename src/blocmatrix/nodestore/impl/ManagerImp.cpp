...
#include <blocmatrix/nodestore/impl/ManagerImp.h>
#include <blocmatrix/nodestore/impl/DatabaseNodeImp.h>
...
ManagerImp::missing_backend()
{
    Throw<std::runtime_error> (
        "Your blocmatrixd.cfg is missing a [node_db] entry, "
        "please see the blocmatrixd-example.cfg file!"
        );
}
